...
protected:
  ...
  /**
   * @brief callback function for the update_zone topic
   *
   * @param msg 带禁行区域地图的yaml文件
   */
  void callbackUpdateKeepoutZone(const std_msgs::msg::String::SharedPtr msg);

private:
  rclcpp_lifecycle::LifecyclePublisher<nav2_msgs::msg::CostmapFilterInfo>::SharedPtr publisher_;

 // 订阅更新禁行区域信息
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr update_keepout_zone_sub_;
